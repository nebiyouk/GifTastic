$(document).ready(function () {
    //add Animation Home page of application when start loading 
    $("#head").hide();
    $("#btn-section").hide();
    $("#btn-section").show(3000, function () {
        $("#head").fadeIn();
    })
    //add music when the application start loading 
    // Gets Link for Theme Song
    var audioElement = document.createElement("audio");
    audioElement.setAttribute("src", "assets/music/Kenny_G_-_Havana_Pesni-Tut.mp3");
    // Theme Button
    ...
    /*Global Variables
    ==============================================================*/
    var topics = ['Music', 'Football', 'Animals', 'Science'];
    var stillImgUrl = '';
    var animateImgUrl = '';
    var gifCondition = '';
    var stillUrl = '';
